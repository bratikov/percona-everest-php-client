...
use Everest\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     */
    public static function deserialize(mixed $data, string $class, ?array $httpHeaders = null): null|array|object|string
    {
        if (null === $data) {
            return null;
        }
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Everest\Model\\' . $data->{$discriminator};
