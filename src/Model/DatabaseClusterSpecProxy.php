 ...
 */
class DatabaseClusterSpecProxy implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseCluster_spec_proxy';
    ...
    protected static array $openAPITypes = [
        ...
        'replicas' => 'int',
        'resources' => '\Everest\Model\DatabaseClusterSpecProxyResources',
        'type' => 'string',
    ];
    ...
    public const TYPE_HAPROXY = 'haproxy';
    public const TYPE_PROXYSQL = 'proxysql';
    public const TYPE_PGBOUNCER = 'pgbouncer';
    ...
    */
     ...
     * Sets config
     *
     * @param null|string $config Config is the proxy configuration
     */
     ...
     * Gets expose
     *
     * @return null|\Everest\Model\DatabaseClusterSpecProxyExpose
     */
    public function getExpose(): mixed
    {
     ...
     * Sets expose
     *
     * @param null|\Everest\Model\DatabaseClusterSpecProxyExpose $expose expose
     */
    public function setExpose(mixed $expose): static
    {
        if (is_null($expose)) {
     ...
     * Sets replicas
     *
     * @param null|int $replicas Replicas is the number of proxy replicas
     */
    public function setReplicas(mixed $replicas): static
    {
        ...
        if (($replicas < 1)) {
            throw new \InvalidArgumentException('invalid value for $replicas when calling DatabaseClusterSpecProxy., must be bigger than or equal to 1.');
        }
     ...
     * Gets resources
     *
     * @return null|\Everest\Model\DatabaseClusterSpecProxyResources
     */
     ...
     * Sets resources
     *
     * @param null|\Everest\Model\DatabaseClusterSpecProxyResources $resources resources
     */
     ...
     * Sets type
     *
     * @param null|string $type Type is the proxy type
     */
