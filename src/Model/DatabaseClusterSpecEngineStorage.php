 ...
 */
class DatabaseClusterSpecEngineStorage implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseCluster_spec_engine_storage';
    ...
    */
     ...
     * Sets class
     *
     * @param null|string $class Class is the storage class to use for the persistent volume claim
     */
    public function setClass(mixed $class): static
    {
        if (is_null($class)) {
