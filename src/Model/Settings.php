...
class Settings implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'Settings';
    ...
    protected static array $openAPITypes = [
        'oidcConfig' => '\Everest\Model\OIDCConfig',
    ];
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['oidcConfig'] === null) {
            $invalidProperties[] = "'oidcConfig' can't be null";
        }
     ...
     * Gets oidcConfig
     *
     * @return \Everest\Model\OIDCConfig
     */
    public function getOidcConfig(): mixed
    {
     ...
     * Sets oidcConfig
     *
     * @param \Everest\Model\OIDCConfig $oidcConfig oidcConfig
     */
    public function setOidcConfig(mixed $oidcConfig): static
    {
