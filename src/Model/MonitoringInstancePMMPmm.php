 ...
 */
class MonitoringInstancePMMPmm implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'MonitoringInstancePMM_pmm';
    ...
    */
     ...
     */
    public function setApiKey(mixed $apiKey): static
    {
        if (is_null($apiKey)) {
            throw new \InvalidArgumentException('non-nullable apiKey cannot be null');
        }
        if ((mb_strlen($apiKey) < 1)) {
            throw new \InvalidArgumentException('invalid length for $apiKey when calling MonitoringInstancePMMPmm., must be bigger than or equal to 1.');
        }
