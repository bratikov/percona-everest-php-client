 ...
 */
class MonitoringInstanceBaseWithName implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'MonitoringInstanceBaseWithName';
    ...
    */
    ...
    public function setUrl(mixed $url): static
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling MonitoringInstanceBaseWithName., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param null|string $name A user defined string name of the storage in the DNS name format https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#dns-label-names
     */
