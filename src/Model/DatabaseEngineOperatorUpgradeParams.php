 ...
 */
class DatabaseEngineOperatorUpgradeParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseEngineOperatorUpgradeParams';
    ...
    */
     ...
     * Sets targetVersion
     *
     * @param string $targetVersion The version to which the operator should be upgraded
     */
