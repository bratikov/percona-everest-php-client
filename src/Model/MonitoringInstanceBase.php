 ...
 */
class MonitoringInstanceBase implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'MonitoringInstanceBase';
    ...
    */
    ...
    public function setUrl(mixed $url): static
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling MonitoringInstanceBase., must be bigger than or equal to 1.');
        }
