 ...
 */
class MonitoringInstance implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'MonitoringInstance';
    ...
    */
    ...
    public function setUrl(mixed $url): static
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling MonitoringInstance., must be bigger than or equal to 1.');
        }
