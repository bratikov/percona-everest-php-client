 ...
 */
class DatabaseClusterSpecDataSourcePitr implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseCluster_spec_dataSource_pitr';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'date');
    }
    ...
    */
     ...
     * Sets date
     *
     * @param null|string $date Date is the UTC date to recover to. The accepted format: \"2006-01-02T15:04:05Z\".
     */
     ...
     * Sets type
     *
     * @param null|string $type Type is the type of recovery.
     */
