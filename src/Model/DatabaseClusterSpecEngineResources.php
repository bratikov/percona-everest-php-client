 ...
 */
class DatabaseClusterSpecEngineResources implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseCluster_spec_engine_resources';
    ...
    */
    ...
    public function setCpu(mixed $cpu): static
    {
        ...
        if (is_string($cpu) && (!preg_match("/^(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))(([KMGTPE]i)|[numkMGTPE]|([eE](\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))))?$/", $cpu))) {
            throw new \InvalidArgumentException("invalid value for \$cpu when calling DatabaseClusterSpecEngineResources., must conform to the pattern /^(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))(([KMGTPE]i)|[numkMGTPE]|([eE](\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))))?$/.");
        }
    ...
    public function setMemory(mixed $memory): static
    {
        ...
        if (is_string($memory) && (!preg_match("/^(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))(([KMGTPE]i)|[numkMGTPE]|([eE](\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))))?$/", $memory))) {
            throw new \InvalidArgumentException("invalid value for \$memory when calling DatabaseClusterSpecEngineResources., must conform to the pattern /^(\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))(([KMGTPE]i)|[numkMGTPE]|([eE](\\+|-)?(([0-9]+(\\.[0-9]*)?)|(\\.[0-9]+))))?$/.");
        }
