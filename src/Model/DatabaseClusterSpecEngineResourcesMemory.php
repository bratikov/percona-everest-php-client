 ...
 */
class DatabaseClusterSpecEngineResourcesMemory implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseCluster_spec_engine_resources_memory';
