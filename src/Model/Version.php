...
class Version implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fullCommit', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['fullCommit'] === null) {
            $invalidProperties[] = "'fullCommit' can't be null";
        }
     ...
     * @return string
     */
    public function getFullCommit(): mixed
    {
        return $this->container['fullCommit'];
    }

    /**
     * Sets fullCommit
     *
     * @param string $fullCommit fullCommit
     */
    public function setFullCommit(mixed $fullCommit): static
    {
        if (is_null($fullCommit)) {
            throw new \InvalidArgumentException('non-nullable fullCommit cannot be null');
        }
        $this->container['fullCommit'] = $fullCommit;
