 ...
 */
class DatabaseClusterComponentContainer implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseClusterComponentContainer';
