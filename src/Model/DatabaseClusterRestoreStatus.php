 ...
 */
class DatabaseClusterRestoreStatus implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseClusterRestore_status';
    ...
    */
     ...
     * Sets completed
     *
     * @param null|\DateTime $completed completed
     */
     ...
     * Sets state
     *
     * @param null|string $state RestoreState represents state of restoration.
     */
