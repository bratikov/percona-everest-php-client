 ...
 */
class UpdateBackupStorageParams implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'UpdateBackupStorageParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('forcePathStyle', $data ?? [], null);
    ...
    */
     ...
     * Sets bucketName
     *
     * @param null|string $bucketName The cloud storage bucket/container name
     */
     ...
     * Sets accessKey
     *
     * @param null|string $accessKey accessKey
     */
     ...
     * Sets secretKey
     *
     * @param null|string $secretKey secretKey
     */
