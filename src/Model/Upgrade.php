...
class Upgrade implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'Upgrade';
    ...
    */
     ...
     * Sets name
     *
     * @param null|string $name Name of the operator
     */
     ...
     * Sets targetVersion
     *
     * @param null|string $targetVersion The next version of the operator to upgrade to.
     */
