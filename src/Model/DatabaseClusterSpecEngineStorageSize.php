 ...
 */
class DatabaseClusterSpecEngineStorageSize implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseCluster_spec_engine_storage_size';
