 ...
 */
class DatabaseEngineStatusOperatorUpgradeInstallPlanRef implements ModelInterface, \ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      */
    protected static string $openAPIModelName = 'DatabaseEngine_status_operatorUpgrade_installPlanRef';
    ...
    */
     ...
     * Sets name
     *
     * @param null|string $name Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?
     */
